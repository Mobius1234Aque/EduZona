...
export function Re2Contraseña() {
  ...
  const handleContinuar = async () => {
    try {
      ...
      const response = await axios.post("https://fast-dusk-08901-dd3e17a6f757.herokuapp.com/verificar-codigo", {
        curp,
        token,
      });
  ...
  const handleGenerarToken = async () => {
    try {
      ...
      const response = await axios.post("https://fast-dusk-08901-dd3e17a6f757.herokuapp.com/generar-token-y-enviar-correo", { curp });
  ...
  const obtenerNombreUsuario = async () => {
    try {
      const response = await axios.get(
        `https://fast-dusk-08901-dd3e17a6f757.herokuapp.com/obtener-nombre/${curp}`
      );
  ...
  const obtenerPregunta = async () => {
    try {
      const response = await axios.get(
        `https://fast-dusk-08901-dd3e17a6f757.herokuapp.com/obtener-pregunta/${curp}`
      );
  ...
  const obtenerTipoPregunta = async () => {
    try {
      const response = await axios.get(
        `https://fast-dusk-08901-dd3e17a6f757.herokuapp.com/obtener-tipo-pregunta/${pregunta}`
      );
  ...
  const obtenerCorreo = async () => {
    try {
      const response = await axios.get(
        `https://fast-dusk-08901-dd3e17a6f757.herokuapp.com/obtener-correo/${curp}`
      );
    ...
    try {
      ...
      if (tipoRecuperacion === "pregunta") {
        ...
        const response = await axios.post(
          "https://fast-dusk-08901-dd3e17a6f757.herokuapp.com/recuperar-contrasena",
          {
            curp,
  ...
  const onFinishActualizarContraseña = async (values) => {
    try {
      const response = await axios.post(
        "https://fast-dusk-08901-dd3e17a6f757.herokuapp.com/actualizar-contrasena",
        {
          curp,
