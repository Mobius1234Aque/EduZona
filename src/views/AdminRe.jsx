        ...
        confirm({
            ...
            async onOk() {
                try {
                    ...
                    const respuesta = await axios.get(`https://fast-dusk-08901-dd3e17a6f757.herokuapp.com/registroBaja?curp=${record.curp}`);
...
3:'Maestro'
    ...
    const obtenerRegistros = async () => {
        try {
            const response = await axios.get("https://fast-dusk-08901-dd3e17a6f757.herokuapp.com/registrosB");
